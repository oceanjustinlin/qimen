...
**2026-09-09 · BaziEngine 1.8.29 / Qimen ruleset dunjia-yanyi-siku-v1 · 古籍规则审计修复**

- 八字修正金水伤官适用范围、目标干十二长生与通根、四生月透干变化；规则升级后不再复用旧 LLM 断语。
- 奇门统一按《遁甲演义》（四库全书本）处理九星相旺废休囚、六仪击刑、五不遇时、三奇得使、玉女守门、三奇墓与天禽寄坤。
- 数值明确标为项目参考指数；LLM 只提供文字复核，不能修改后端确定性指标。审计与修复证据见 [`docs/audits/2026-09-07-mechanism/REPORT.md`](./docs/audits/2026-09-07-mechanism/REPORT.md)。
...
- **旺衰接入（`prosperity`）**：当时首次把九星月令状态接入 `evaluatePalace`；该版使用的普通五行旺相休囚死口径已在 2026-09-09 审计中更正为《遁甲演义》的相、旺、废、休、囚专法。
